...
export default function GlobalError({
  ...
  return (
    <html lang="en" className="dark">
      <body className="bg-slate-50 font-sans antialiased text-zinc-900 flex items-center justify-center min-h-screen p-4 select-none">
        <div className="max-w-md w-full bg-white border border-zinc-200 rounded-lg shadow-card p-6 space-y-4 text-center">
