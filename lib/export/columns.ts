 ...
 * Authoritative production database mapping.
...
export interface ColumnSpec {
  id: string;
  label: string;
  dbCol: string; // Exact SQL column name or expression
...
export const PAYMENT_TEAM_COLUMNS: ColumnSpec[] = [
  ...
  { id: 'first_jurisdiction', label: '1st Jurisdiction', dbCol: 'first_jurisdiction', defaultVisible: false, type: 'text' },
  { id: 'second_jurisdiction', label: '2nd Jurisdiction', dbCol: 'second_jurisdiction', defaultVisible: false, type: 'text' },
  ...
  { id: 'external_id', label: 'External Id', dbCol: 'external_id', defaultVisible: false, type: 'text' },
  ...
  { id: 'latest_update', label: 'Latest Update', dbCol: 'latest_update', defaultVisible: false, type: 'date' },
  { id: 'latest_update_by_requester', label: 'Latest Update By Requester', dbCol: 'latest_update_by_requester', defaultVisible: false, type: 'boolean' },
  ...
  { id: 'preferred_language', label: 'Preferred Language', dbCol: 'preferred_language', defaultVisible: false, type: 'text' },
  ...
  { id: 'step_link', label: 'Step Link', dbCol: 'step_link', defaultVisible: false, type: 'link' },
  ...
  { id: 'tags', label: 'Tags', dbCol: 'NULL AS tags', defaultVisible: false, type: 'text' },
  { id: 'total_passengers_number', label: 'Total Passengers Number', dbCol: 'total_passengers_number', defaultVisible: false, type: 'text' },
  { id: 'utm', label: 'UTM', dbCol: "CONCAT_WS(' / ', NULLIF(utm_source,''), NULLIF(utm_medium,''), NULLIF(utm_campaign,''), NULLIF(utm_content,''), NULLIF(utm_id,''))", defaultVisible: false, type: 'text' },
  ...
  { id: 'complete_route', label: 'Complete Route', dbCol: 'complete_route', defaultVisible: false, type: 'text' },
];
